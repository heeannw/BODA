...
public class ExploreContentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contentList.add(new ContentItem(R.drawable.app_logo, "청소년 음주예방 광고", "청소년 대상 경고 메시지를 담은 캠페인", "#청소년 #광고"));
        contentList.add(new ContentItem(R.drawable.app_logo, "사이버 폭력 예방 영상", "학교 내 따돌림 문제 해결을 위한 애니메이션", "#청소년 #폭력"));
        contentList.add(new ContentItem(R.drawable.app_logo, "공익 캠페인 사례", "사회적 약자 보호를 위한 캠페인 사례", "#사회 #캠페인"));
